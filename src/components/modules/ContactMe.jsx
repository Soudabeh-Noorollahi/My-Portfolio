...
function ContactMe() {
  ...
  return (
    <div className="px-10 xl:px-16 mt-20">
      <motion.h3
        className="text-2xl font-semibold w-fit text-neutral-700 mx-auto mb-10 border-b-2 pb-2 border-violet-600"
      ...
      >
        ...
        <button
          type="submit"
          className="bg-violet-600 text-white py-2 rounded-lg hover:bg-violet-700 transition-all"
        >
          Send Message
        </button>
      </motion.form>
